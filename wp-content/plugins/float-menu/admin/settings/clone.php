            ...
            <div class="panel-block">
                <div class="columns">
                    <div class="field column">
                        <label class="label">
					        <?php esc_attr_e( 'Color', 'float-menu' ); ?>
                        </label>
				        <?php self::option( $menu_1_color ); ?>
                    </div>
                    <div class="field column">
                        <label class="label">
					        <?php esc_attr_e( 'Hover Color', 'float-menu' ); ?>
                        </label>
				        <?php self::option( $menu_1_hcolor ); ?>
                    </div>
                </div>
            </div>
            <div class="panel-block">
                <div class="columns">
                    <div class="column field">
                        <label class="label">
					        <?php esc_attr_e( 'Background', 'float-menu' ); ?>
                        </label>
				        <?php self::option( $menu_1_bcolor ); ?>
                    </div>
                    <div class="column field">
                        <label class="label">
					        <?php esc_attr_e( 'Hover Background', 'float-menu' ); ?>
                        </label>
